#=GENOME_DIFF	1.0
#=CREATED	13:43:23 25 Nov 2022
#=PROGRAM	breseq 0.35.0 
#=COMMAND	breseq --reference /workspace/home/nasirja/covid-19-signal/data/MN908947.3.gbk --num-processors 4 --polymorphism-prediction --brief-html-output --output Plate3BLANK1/breseq Plate3BLANK1/mapped_clean_reads/Plate3BLANK1_R1.fastq.gz Plate3BLANK1/mapped_clean_reads/Plate3BLANK1_R2.fastq.gz
#=REFSEQ	/workspace/home/nasirja/covid-19-signal/data/MN908947.3.gbk
#=READSEQ	Plate3BLANK1/mapped_clean_reads/Plate3BLANK1_R1.fastq.gz
#=READSEQ	Plate3BLANK1/mapped_clean_reads/Plate3BLANK1_R2.fastq.gz
#=CONVERTED-BASES	18969
#=CONVERTED-READS	76
#=INPUT-BASES	18969
#=INPUT-READS	76
#=MAPPED-BASES	17269
